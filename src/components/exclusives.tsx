...
const exclusives = [
    {
        title: "Local Portfolios",
        description:
            "Access local investment opportunities through our collaboration with ICICI Direct, customized to suit your financial objectives.",
        image: "/exclusives/exchange.png",
    },
    {
                    ...
                    <div className="relative flex flex-col mt-6 bg-gradient-to-br from-[#3d4957] to-[#282e3a] text-white shadow-md bg-clip-border rounded-xl max-w-xl text-center">
                        ...
                        <div className="p-6 pt-0">
                            <a href="#" className="inline-block">
                                ...
                                >
                                    {index !== 2 ? "Learn More" : "Coming Soon"}
                                    {index !== 2 && (
                                        <svg
