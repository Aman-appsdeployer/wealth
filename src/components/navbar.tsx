...
function MobileNavigation() {
    return (
        <div className="flex items-center md:hidden pointer-events-auto gap-4">
            <Select
                defaultValue="india"
                onValueChange={(value) => {
                    if (value === "india") {
        ...
        <nav className="pointer-events-auto hidden md:block">
            <ul className="flex items-center font-sans whitespace-nowrap rounded-full px-3 text-[0.95rem] font-semibold shadow-2xl dark:shadow-xl dark:shadow-white/5 ring-1 ring-zinc-900/5 bg-background">
                ...
                {/* <NavItem href="/" disabled>
                    <div className="relative pointer-none mx-2">
                        <img
                            src="/coming-soon.png"
                            className="z-[20] scale-125 absolute bottom-[0.1rem]"
                        />
                        <span className="">Ethosphere</span>
                    </div>
                </NavItem> */}
            </ul>
        </nav>
    ...
    return (
        <div className="z-50 w-full fixed backdrop-blur-2xl">
            <header className=" relative z-50 container">
                <div className="relative flex gap-4 md:items-center">
