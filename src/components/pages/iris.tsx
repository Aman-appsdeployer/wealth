...
const Iris = () => {
    ...
    return (
        <section className="py-5 sm:py-16 lg:py-1">
            ...
            <div className="flex md:container py-10 w-96">
                            ...
                            >
                                <AccordionItem value="item-1" className="">
                                    ...
                                    <AccordionContent className="px-5 py-2">
                                        <RadioGroup onValueChange={(option) => setRegion(option)} defaultValue={region}>
                ...
                <div className="w-full md:px-8 px-3">
                    <div className="">
                        ...
                        <div className="hidden md:block">
                            <div className="flex flex-row items-center gap-24 border border-secondary/25 shadow-md rounded-2xl p-4 whitespace-nowrap py-2 my-3.5 ">
                                {/* Filter By Header */}
                                ...
                                {/* Accordion for Region and Sector */}
                                        ...
                                        <AccordionItem value="item-1">
                                            ...
                                            <AccordionContent className="px-5 py-2">
                                                <RadioGroup onValueChange={(option) => setRegion(option)} defaultValue={region}>
                                                    <div className="flex flex-col gap-3">
                                                        {irisRegions.map((r) => (
                                                            <div className="flex items-center space-x-2" key={r.name}>
                                    ...
                                    <Accordion type="single" collapsible className="w-full max-w-xs">
                                        <AccordionItem value="item-2">
                                            ...
                                            <AccordionContent className="px-5 py-2">
                                                <div className="flex flex-col gap-3">
                                                    {irisSectors.map((sector) => (
                                                        <div className="flex items-center space-x-2" key={sector.industryMasterName}>
                                                            <Checkbox
                                                                id={sector.industryMasterName}
                                                                checked={sectors.find(
                                                                    (s) => s.industryMasterName === sector.industryMasterName
                                                                ) !== undefined}
