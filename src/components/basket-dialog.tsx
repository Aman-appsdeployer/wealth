...
import { cn, globalBasketsData, indianBasketsData } from "@/lib/utils";
...
const BasketDialog: React.FC<BasketDialogProps> = ({
    ...
    const basketData =
        basket === "global" ? globalBasketsData : indianBasketsData;

    const apiData = basket === "global" ? globalApi : indianApi;
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-2xl">
                ...
                {apiData[index] !== -1 && <Graph id={apiData[index]} />}
